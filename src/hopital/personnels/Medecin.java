...
public class Medecin extends Personnel {
	...
	public Medecin(String firstName, String lastName, String email, String password) {
		...
		try {
			...
			/*
			 * Creation du dossier du medecin permetant de contenir un fichier
			 * "patients.txt" du medecin
			 */
			 ...
			 */
			OutputStreamWriter writer = new OutputStreamWriter(Hopital.getMedecinWriterFile(), StandardCharsets.UTF_8);
